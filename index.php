...
<body>
    ...
    <main id="index">
        <?php if(!isset($_SESSION['jeu']) && isset($_SESSION['login'])){ ?>
        <form action="index.php" method="POST">
            <button type="submit" name="valider">Start Game</button>
        </form>
        <?php 
            }
        ...
        <?php
            ...
            if (isset($caract)) // si le jeu a été créé
            {
                ...
                echo '<section id="mot_img_lettre">';
                echo '<section id="mot_img">';
                echo '<section id="mot_pendu">';
                for ($x = 0; $x < $longueur; $x++) // boucle du nombre de lettre du mot
                {
                    ...
                    {
                        echo '<img src="img/alpha/back.png" alt="back" class="trait">';
                    }
                    else
                    {
                        $image = $caract[$x]->getaspect();
                        echo "<img src='img/alpha/$image' alt='image lettre' class='lettre_mot'>";
                    }
                }
                echo '</section>';
                ...
                $nice = $_SESSION['nice'];
                echo '<section id="img_pendu">';
                echo '<img src="img/pendaison/'.$evolution.'.png" class="pendaison">';
                echo '</section>';
                echo '</section>';
        ...
        if (isset($nice) && isset($longueur))
        {
            ...
            {
        ?>
            <form action="" method="POST" id="form_lettre">
        ...
        if (isset($_SESSION['reponses']))
        {
            ...
            for ($l = 0; $l < COUNT($allrep); $l++) // affichage des lettres utilisées
            {
                if(isset($allrep[$l]))
                {
                    echo "<img src='img/alpha/$allrep[$l].png' alt='$allrep[$l]' id='lettre_use' >";
                }
            }
            echo '</section>';
        }
